...
var Mocha = require('mocha'),
  ...
  walk_dir = require('./support/walk_dir'),
  argv = optimist.usage("Usage: $0 -t [types] --reporter [reporter] --timeout [timeout]").default({
  ...
  valid_test_types = ['unit', 'functional', 'acceptance', 'integration'],
  requested_types = argv.types.split(','),
  types_to_use = [],
  is_valid_file = function (file) {
